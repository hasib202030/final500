    ...
    <div class="col-lg-8">
        ...
        <form action="{{ route('users.update', $user->id )}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-control" id="exampleInputPassword1" placeholder="Student Name" value="{{ $user->name ?? '' }}">
            ...
            <div class="form-group">
                ...
                <input name="email" type="email" class="form-control" id="exampleInputPassword1" placeholder="Email" value="{{ $user->email ?? '' }}">
